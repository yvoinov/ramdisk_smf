...
Package contains scripts and files:

ram.conf                       - config file.
ramdisk                        - Ramdisk control method. 
ramdisk.xml                    - Ramdisk service manifest.
ramdisk_smf_inst.sh            - Installation script.
ramdisk_smf_rmv.sh             - Uninstallation script.
